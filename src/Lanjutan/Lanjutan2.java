 ...
 * @author tio
 */
public class Lanjutan2 extends javax.swing.JFrame {

    /**
     * Creates new form Lanjutan2
     */
    public Lanjutan2(String nama, String absen, String kelas, String jurusan, String alamat) {
        initComponents();
        Hasil1.setText(nama);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lanjutan2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
